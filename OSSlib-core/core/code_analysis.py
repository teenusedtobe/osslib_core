        ...
        for oss_info in OsslibMetadata_2.select(OsslibMetadata_2.q.id=='45809'):
            ...
            if oss_info.oss_local_path != '':
                try:
                    ...
                    #Activity
                    #32week表
                    for info in ActivityWeek.select(ActivityWeek.q.project_name==data.projectname):
                        info.delete(info.id)
                    item=dict()
                    item['project_name']=data.projectname
                    WEEKS = 32
                    ...
                    #24hour表
                    for info in ActivityHour.select(ActivityHour.q.project_name==data.projectname):
                        info.delete(info.id)
                    item=dict()
                    item['project_name']=data.projectname
                    ...
                    #7day表
                    for info in ActivityDay.select(ActivityDay.q.project_name==data.projectname):
                        info.delete(info.id)
                    item=dict()
                    item['project_name']=data.projectname
                    ...
                    #hour_week表
                    for info in ActivityHourOfWeek.select(ActivityHourOfWeek.q.project_name==data.projectname):
                        info.delete(info.id)
                    item=dict()
                    item['project_name']=data.projectname
                    ...
                    #month表
                    for info in ActivityMonth.select(ActivityMonth.q.project_name==data.projectname):
                        info.delete(info.id)
                    item=dict()
                    item['project_name']=data.projectname
                    ...
                    #year表
                    for info in ActivityYear.select(ActivityYear.q.project_name==data.projectname):
                        info.delete(info.id)
                    item=dict()
                    item['project_name']=data.projectname
                    ...
                    #year_month表
                    for info in ActivityYearMonth.select(ActivityYearMonth.q.project_name==data.projectname):
                        info.delete(info.id)
                    item=dict()
                    item['project_name']=data.projectname
                    ...
                    #timezone表
                    for info in ActivityTimezone.select(ActivityTimezone.q.project_name==data.projectname):
                        info.delete(info.id)
                    item=dict()
                    item['project_name']=data.projectname
                    ...
                    #Author
                    #list
                    for info in AuthorList.select(AuthorList.q.project_name==data.projectname):
                        info.delete(info.id)
                    item=dict()	
                    item['project_name']=data.projectname
                    count=0						
                    ...
                    for info in AuthorCumulated.select(AuthorCumulated.q.project_name==data.projectname):
                        info.delete(info.id)
                    item=dict()
                    item['project_name']= data.projectname
                    lines_by_authors={}
                    ...
                    #month(author)表
                    for info in AuthorMonth.select(AuthorMonth.q.project_name==data.projectname):
                        info.delete(info.id)
                    item=dict()
                    item['project_name']=data.projectname
                    ...
                    #year(author)表
                    for info in AuthorYear.select(AuthorYear.q.project_name==data.projectname):
                        info.delete(info.id)
                    item=dict()
                    item['project_name']=data.projectname
                    ...
                    #domains表
                    for info in Domain.select(Domain.q.project_name==data.projectname):
                        info.delete(info.id)
                    item=dict()
                    item['project_name']=data.projectname
                    ...
                    #files
					#count by date
                    for info in FileDateCount.select(FileDateCount.q.project_name==data.projectname):
                        info.delete(info.id)
                    item=dict()
                    item['project_name']=data.projectname
                    ...
                    #extension
                    for info in FileExtension.select(FileExtension.q.project_name==data.projectname):
                        info.delete(info.id)
                    item=dict()
                    item['project_name']=data.projectname
                    ...
                    #lines
                    #lines count by date
                    for info in LineDateCount.select(LineDateCount.q.project_name==data.projectname):
                        info.delete(info.id)
                    item=dict()
                    item['project_name']=data.projectname
                    ...
                    #tag
                    for info in Tag.select(Tag.q.project_name==data.projectname):
                        info.delete(info.id)
                    item=dict()
                    item['project_name']=data.projectname
